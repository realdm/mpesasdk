...
import kotlinx.android.synthetic.main.mpesa_sdk_view_c2b_authentication.view.description as authMessageView
...
class C2BPaymentAuthenticationView @JvmOverloads constructor(
    ...
    init {
        inflate(context, R.layout.mpesa_sdk_view_c2b_authentication, this)
