...
object MpesaSdk {
	...
	const val ARG_RESULT_THIRD_PARTY_REFERENCE = "third_party_reference"
	...
	private var _httpLoggingInterceptor: HttpLoggingInterceptor? = null
	val httpLoggingInterceptor: HttpLoggingInterceptor?
		get() = _httpLoggingInterceptor

	fun init(apiKey: String, publicKey: String, endpointUrl: String, serviceProviderName: String,
			 serviceProviderCode: String, serviceProviderLogoUrl: String,
		...
		_httpLoggingInterceptor = httpLoggingInterceptor
		initialized = true
	}
	...
	fun pay(activity: Activity, requestCode: Int, amount: String, transactionReference: String,
		...
		val intent = Intent(activity, PaymentActivity::class.java).apply {
			val args = createPaymentBundle(amount, transactionReference, thirdPartyReference)
			putExtras(args)
		}
	...
	private fun createPaymentBundle(amount: String, transactionReference: String,
									thirdPartyReference: String): Bundle {
